...
![Time of computation, paper results](3-1-2-1-graphs/time.png){ width=80% }
...
![Ranking of imputation methods for each model](3-1-2-1-graphs/ranking.png){ width=80% }

![Visualisation of paper results](3-1-2-1-graphs/ranking_plot.png){ height=80% }
